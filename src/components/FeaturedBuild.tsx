...
export const FeaturedBuild = (props: FeaturedBuildProps) => {
    ...
    return (
        <div className="p-3 rounded flex flex-col-reverse lg:flex-row flex-wrap lg:p-6 lg:pl-12 relative justify-center items-center mb-20 dark:bg-slate-900  transition-all duration-150 rounded">
